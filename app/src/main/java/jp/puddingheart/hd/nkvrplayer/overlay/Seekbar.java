...
public class Seekbar extends GVRSceneObject {
    ...
    public Seekbar(GVRContext gvrContext) {
        ...
        mPlayedSide = new GVRSceneObject(gvrContext, gvrContext.createQuad(
                1.0f, 0.1f), gvrContext.getAssetLoader().loadTexture(new GVRAndroidResource(gvrContext, R.drawable.dark_gray)));
        ...
        mLeftSide = new GVRSceneObject(gvrContext, gvrContext.createQuad(1.0f,
                0.1f), gvrContext.getAssetLoader().loadTexture(new GVRAndroidResource(gvrContext, R.drawable.light_gray)));
        ...
        mPointer = new GVRSceneObject(gvrContext, gvrContext.createQuad(0.08f,
                0.3f), gvrContext.getAssetLoader().loadTexture(new GVRAndroidResource(gvrContext, R.drawable.dark_gray_circle)));
        ...
        mGlow = new GVRSceneObject(gvrContext,
                ...
                gvrContext.getAssetLoader().loadTexture(new GVRAndroidResource(gvrContext, R.drawable.seekbar_glow)));
